//In traditional collection if one thread iterates and other tries to modify structural change then ConcurrentModificationException
//is thrown.
...
//using segment index, now based on the hashcode of particular bucket the bucket number of that bucket is calculated. Also, 
