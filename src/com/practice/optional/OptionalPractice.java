...
//		 String str = "Random Text";
		String str = null;
		// WHEN YOU ARE SURE THE VALUE IS NOT NULL YOU SHOULD USE of OTHERWISE
		// YOU CAN USE ofNullable
...
//		// IF the upperString IS NULL WE WILL GET AN EXCEPTION FOR THE BELOW
//		// LINE WE CAN HANDLE THIS BY CHECKING
//		// THE VALUE IS PRERENT USING isPresent
//		upperString = OptionalPractice.getString().get().toUpperCase();

//		// isPresent WILL RETURN TRUE IF THE VALUE IS PRESENT OTHERWISE IT
//		// WILL RETURN FALSE
//		 if (OptionalPractice.getString().isPresent())
//		 //get WILL GIVE YOU THE VALUE IF IT IS PRESENT
...
//		// // SINCE WE ARE PASSING LAMBDA EXPRESSION SO WE CAN USE METHOD
//		// REFERENCE
//		 OptionalPractice.getString().ifPresent(System.out::println);
		...
		// THE METHOD orElseGet accepts a supplier, IF OUR LOGIC IS TOO BIG WE
		// CAN USE orElseGet OTHERWISE WE CAN
		// USE orElse
		System.out.println(OptionalPractice.getString().orElseGet(() -> "NA"));
		// THE METHOD orElseThrow accepts a Supplier, IF WE NEED TO THROW ANY
		// EXCEPTION WE CAN USE orElseThrow
